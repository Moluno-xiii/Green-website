...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="text-white flex mx-auto justify-between h-24 2xl:h-40 items-center max-w-[1240px] px-4 2xl:max-w-[2200px] font-semibold">
      <h1 className="text-3xl 2xl:text-5xl 3xl:text-6xl font-bold text-[#00df9a] cursor-pointer hover:text-white duration-500">
        REACT.
      </h1>
      <ul className="flex max-md:hidden 2xl:text-2xl xl:text-xl lg:text-lg ">
        ...
        <li className="text-black ml-4 border border-[#00df9a]  rounded-2xl bg-[#00df9a]  3xl:px-4 my-8 mx-4 py-2 w-32  3xl:w-[200px] xl:w-40 text-center hover:bg-white hover:text-[#00df9a] duration-500 hover:border-white cursor-pointer">
          <a href="#get-started">Get Started</a>
        </li>
      </ul>

      <div className="md:hidden hover:text-green-400 " onClick={handleShowNav}>
      ...
      {showNav && (
        <div className="ml-0 flex flex-col fixed left-0 top-0 max-sm:w-[80%] w-[70%] border-r border-r-gray-900 h-[100vh] mt-0 pt-6 uppercase bg-black m-4 z-[100]">
          ...
          <ul className="uppercase p-4">
            ...
            <li className="p-4  border-b border-b-gray-800 hover:text-green-300 duration-300">
              <a href="#pricing" onClick={handleShowNav}>
                Pricing
              </a>
            </li>
            <li className="p-4  border-b border-b-gray-800 hover:text-green-300 duration-300">
